...
urlpatterns = [
    ...
    path('follow/<str:username>/', views.follow_unfollow, name='follow-unfollow'),
    path('account/', views.userAccount, name='account'),
    path('edit-account/', views.editAccount, name='edit-account'),
    path('create-interest/', views.createInterest, name='create-interest'),
    path('update-interest/<slug:interest_slug>/', views.updateInterest, name='update-interest'),
    path('delete-interest/<slug:interest_slug>/', views.deleteInterest, name='delete-interest'),
